/area/nebelstrand
	abstract_type = /area/nebelstrand
	allow_xenoarchaeology_finds = FALSE
	icon = 'maps/nebelstrand/areas/icons.dmi'
	icon_state = "area"
...
/area/nebelstrand/outside
	...
	description = "Birds and insects call from the grasses, and a cool wind gusts from across the ocean."
	area_blurb_category = /area/nebelstrand/outside
