/decl/department/nebelstrand/visitors
	name                    = "Visitors"
	colour                  = "#685b40"
	display_color           = "#c4bc8c"

/datum/job/nebelstrand/visitor
	abstract_type           = /datum/job/nebelstrand/visitor
	department_types        = list(/decl/department/nebelstrand/visitors)
...
/obj/abstract/landmark/start/nebelstrand/traveller
	name                    = "Traveller"
...
/datum/job/nebelstrand/visitor/traveller/learned
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/nebelstrand/traveller/scholar
	skill_points            = 26
	min_skill               = list(
...
/obj/abstract/landmark/start/nebelstrand/traveller/learned
...
/datum/job/nebelstrand/visitor/beggar_knight
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/nebelstrand/beggar_knight
	min_skill               = list(
...
/obj/abstract/landmark/start/nebelstrand/beggar_knight
	name                    = "Beggar Knight"
...
/datum/job/nebelstrand/visitor/traveller/cleric
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/nebelstrand/traveller/cleric
	min_skill               = list(
		SKILL_COMBAT        = SKILL_ADEPT,
		SKILL_WEAPONS       = SKILL_ADEPT,
		SKILL_ATHLETICS     = SKILL_ADEPT,
...
/obj/abstract/landmark/start/nebelstrand/cleric
